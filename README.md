...
Program ini dibangun menggunakan 3 class utama yang saling berinteraksi secara independen tanpa menggunakan pewarisan (inheritance):
...
Akses terhadap atribut private pada seluruh class dikendalikan menggunakan dekorator property Python.
